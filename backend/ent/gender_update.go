...
func (gu *GenderUpdate) SetGname(s string) *GenderUpdate {
	gu.mutation.SetGname(s)
	return gu
}

// AddFromgenderIDs adds the fromgender edge to Patient by ids.
func (gu *GenderUpdate) AddFromgenderIDs(ids ...int) *GenderUpdate {
	gu.mutation.AddFromgenderIDs(ids...)
	return gu
}

// AddFromgender adds the fromgender edges to Patient.
func (gu *GenderUpdate) AddFromgender(p ...*Patient) *GenderUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return gu.AddFromgenderIDs(ids...)
}
...
func (gu *GenderUpdate) RemoveFromgenderIDs(ids ...int) *GenderUpdate {
	gu.mutation.RemoveFromgenderIDs(ids...)
	return gu
}

// RemoveFromgender removes fromgender edges to Patient.
func (gu *GenderUpdate) RemoveFromgender(p ...*Patient) *GenderUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return gu.RemoveFromgenderIDs(ids...)
}
...
func (gu *GenderUpdate) Save(ctx context.Context) (int, error) {
	if v, ok := gu.mutation.Gname(); ok {
		if err := gender.GnameValidator(v); err != nil {
			return 0, &ValidationError{Name: "Gname", err: fmt.Errorf("ent: validator failed for field \"Gname\": %w", err)}
		}
	}
...
func (gu *GenderUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := gu.mutation.RemovedFromgenderIDs(); len(nodes) > 0 {
	...
	if nodes := gu.mutation.FromgenderIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   gender.FromgenderTable,
...
// SetGname sets the Gname field.
func (guo *GenderUpdateOne) SetGname(s string) *GenderUpdateOne {
	guo.mutation.SetGname(s)
	return guo
}

// AddFromgenderIDs adds the fromgender edge to Patient by ids.
func (guo *GenderUpdateOne) AddFromgenderIDs(ids ...int) *GenderUpdateOne {
	guo.mutation.AddFromgenderIDs(ids...)
	return guo
}

// AddFromgender adds the fromgender edges to Patient.
func (guo *GenderUpdateOne) AddFromgender(p ...*Patient) *GenderUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return guo.AddFromgenderIDs(ids...)
}
...
// RemoveFromgenderIDs removes the fromgender edge to Patient by ids.
func (guo *GenderUpdateOne) RemoveFromgenderIDs(ids ...int) *GenderUpdateOne {
	guo.mutation.RemoveFromgenderIDs(ids...)
	return guo
}

// RemoveFromgender removes fromgender edges to Patient.
func (guo *GenderUpdateOne) RemoveFromgender(p ...*Patient) *GenderUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return guo.RemoveFromgenderIDs(ids...)
}
...
func (guo *GenderUpdateOne) sqlSave(ctx context.Context) (ge *Gender, err error) {
	...
	if nodes := guo.mutation.RemovedFromgenderIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   gender.FromgenderTable,
	...
	if nodes := guo.mutation.FromgenderIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   gender.FromgenderTable,
