...
export function EntGenderEdgesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntGenderEdges {
    ...
    return {
        ...
        'fromgender': !exists(json, 'fromgender') ? undefined : ((json['fromgender'] as Array<any>).map(EntPatientFromJSON)),
    };
}
...
export function EntGenderEdgesToJSON(value?: EntGenderEdges | null): any {
    ...
    return {
        ...
        'fromgender': value.fromgender === undefined ? undefined : ((value.fromgender as Array<any>).map(EntPatientToJSON)),
    };
}
